...
module.exports = class Teams extends Diffable {
  ...
  update (existing, attrs) {
    return this.github.team.addOrUpdateRepo(this.toParams(existing, attrs))
  }
  ...
  add (attrs) {
    ...
    return this.allTeams.then(teams => {
      ...
      return this.github.orgs.addOrUpdateRepo(this.toParams(existing, attrs))
    })
  }

  remove (existing) {
    return this.github.team.removeRepo(
  ...
  get allTeams () {
    const getter = this.github.orgs.listTeams({ org: this.repo.owner })
